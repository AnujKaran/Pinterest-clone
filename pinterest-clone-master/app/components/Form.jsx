...
function Form() {
  ...
  return (
    <div className=' bg-white p-16 rounded-2xl  text-blue'>
       ...
       <div className='w-[100%]'>
        ...
        className='text-[35px] outline-none font-bold w-full text-gray-900
        ...
        border-b-[2px] border-gray-400 placeholder-gray-400 text-gray-900'/>
          <input type="text"
